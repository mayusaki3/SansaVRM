...
#### 7.6.2 Property 制約検証
<!-- hldocs:sec_id=sec_f3a8b5w6 -->

Property の context は必須項目であり、Property.properties.context.enum に定義された列挙値のいずれかでなければならない。
