<!--
HLDocS:LLM-MANAGED
doc_id: dry-doc-5002-validator-implementation-specification
lang: ja-JP
canonical_title: Validator実装仕様
document_type: spec
canonical_document: true
-->

[目次](../../目次.md) > 仕様 > Validation Layer > Validator実装仕様
...
Validator は、JSONスキーマ仕様による構造検証を補完し、JSON Schema だけでは完全に検証できない参照整合性、意味整合性、相互整合性、および変換由来の妥当性確認を担う。
...
各 index は一意なキー集合として構築し、重複があれば直ちに error を記録する。
